...
final class GetOrganizationsByBuildingController extends Controller
{
     ...
     *     tags={"Organizations"},
     *     security={{"apiKey":{}}},
     *     @OA\Parameter(name="id", in="path", required=true, @OA\Schema(type="integer"), description="Идентификатор здания"),
    ...
    public function __invoke(OrganizationByIdRequest $request): AnonymousResourceCollection
    {
        ...
        return OrganizationResource::collection($this->organizationService->getByBuildingId($data['id']));
    }
}
